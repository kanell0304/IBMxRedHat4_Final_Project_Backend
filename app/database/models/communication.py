...
class Communication(Base):
    ...
    m_category_id: Mapped[Optional[int]] = mapped_column(Integer,ForeignKey('main_category.m_category_id', ondelete='SET NULL'))  # main_category fk => 없어서 추가했습니다 - 이경준
    ...
    main_category: Mapped[Optional["MainCategory"]] = relationship("MainCategory",back_populates="communications") # 관계도 추가 - 이경준
