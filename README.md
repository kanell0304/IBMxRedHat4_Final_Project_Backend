...
AI/ML: PyTorch, Wav2Vec2(meta), Whisper(openai), OpenAI API, Google STT, BERT <br>
Database: MySQL, ChromaDB <br>
Infra(CI/CD): AWS(Route53, ALB, ECS, ECR, RDS, S3), Docker, GitHub Actions <br>
